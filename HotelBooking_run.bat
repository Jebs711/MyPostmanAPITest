...
REM Run Newman
newman run HoteBookingAPIs.postman_collection.json -r htmlextra ^
--reporter-htmlextra-export "C:\Users\Public\Documents\API_Results\HotelBookingAPIs\HotelBookingAPI_Report_%ts%.html" ^
--reporter-htmlextra-browserTitle "API Test Report" ^
--reporter-htmlextra-title "HotelBookingAPIs Test Result" ^
