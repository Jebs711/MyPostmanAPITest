...
REM Run Newman
newman run JWTAuth.postman_collection.json -r htmlextra ^
--reporter-htmlextra-export "C:\Users\Public\Documents\API_Results\JWTAuthAPIs\JWTAuthAPI_Report_%ts%.html" ^
--reporter-htmlextra-browserTitle "API Test Report" ^
--reporter-htmlextra-title "JWTAuthAPIs Test Result" ^
