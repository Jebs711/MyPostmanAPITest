...
REM Run Newman
newman run RestfulAPIs.dev.postman_collection.json -r htmlextra ^
--reporter-htmlextra-export "C:\Users\Public\Documents\API_Results\RestfulAPIdev\RestfulAPIdev_Report_%ts%.html" ^
--reporter-htmlextra-browserTitle "API Test Report" ^
--reporter-htmlextra-title "RestfulAPIsDev API Test Result" ^
